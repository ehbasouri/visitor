  ...
  function getTotalBuyPrice() {
    ...
    updatedOrder.products.map(
      (product) =>
        (totalBuyPrice =
          totalBuyPrice +
          (product.buy_price / product.count_in_box) *
            product.unitCountInBasket +
          product.buy_price * product.countInBasket)
    );
    updatedOrder.gift.map(
      (giftItem) =>
        (totalBuyPrice =
          totalBuyPrice +
          (giftItem.buy_price / giftItem.count_in_box) *
            giftItem.unitCountInBasket +
          giftItem.buy_price * giftItem.countInBasket)
    );
      ...
      <MainScreen>
        <Card className={classes.root}>
          <CardHeader
            avatar={
              <Avatar
                src={HOST + updatedOrder.client.avatar}
                aria-label="recipe"
          ...
          <CardContent>
            ...
            <OrderInfoItem
              ...
              value={converEnglishNumToPersian(
